...
public class SalaryController {
    ...
    public void totalSalary(Object o){
        if(o instanceof Doctor){
            Doctor d = (Doctor) o;
            extra_salary=0;
            // for(int i=0 ; i< d.getIncident() ; i++){
            //     extra_salary += 50; 
            // }
            extra_salary = 50 * d.getIncident();
            total_salary = d.getSalary() + extra_salary;
            System.out.println(d.getFirstName() + " " + d.getLastName()+ " with id: " + d.getId() + " has " + total_salary + "€");
            }
        if(o instanceof SurgeonDoctor){
            ...
            System.out.println(sd.getFirstName() + " " + sd.getLastName()+ " with id: " + sd.getId() + " has " + total_salary + "€");
        }
        if(o instanceof Nurse){
            ...
            System.out.println(n.getFirstName() + " " + n.getLastName()+ " with id: " + n.getId() + " has " + total_salary + "€");
        }
